...
# first, x gets evaluated to 5, 5/2 gets evaluated to 2.5, then sqrt(2.5) is evaluated
sqrt(x/2)

# we can also store the evaluated value of x/2 in an object y before passing it to sqrt()
y <- x/2

sqrt(y)

# first, the x on the righthand side gets evaluated to 5, then it gets squared, then the resulting value is assigned to the object x
